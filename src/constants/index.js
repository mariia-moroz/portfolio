...
const work = [
  {
    ...
    points: [
      "Developed and maintained Node.js services supporting high-availability, real-time trading data pipelines",
      "Built and optimised integrations with 200+ cryptocurrency exchanges (including Coinbase, Binance, Bybit), ensuring data accuracy and consistency",
      "Monitored and debugged real-time data pipelines using Datadog and Graylog, reducing downtime and improving system reliability",
      "Worked with distributed system architecture, managing services, VMs, Redis, PostgreSQL, and Azure Storage",
      "Collaborated with cross-functional teams to deliver scalable backend solutions in an Agile environment",
    ],
  },
];
