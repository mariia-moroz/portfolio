...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-[#0D0829]] ${scrolled ? "bg-[#0D0829]" : "bg-transparent"}`}
    >
      <div
      ...
      >
        ...
        <div className='md:hidden md:w-0 flex md:flex-1 ml-6 justify-end items-center'>
          ...
          <div
            className={`${isOpenMenu ? "flex" : "hidden"} px-8 py-6 bg-gradient-to-r from-[#373061] to-[#1d0745] absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
          >
