    ...
    return (
        <>
            <div className="flex gap-10 justify-center overflow-hidden">
                <motion.div variants={fadeIn('up', 'tween', 0.2, 0.8)} className="flex max-lg:w-full lg:flex-[0.65] rounded-[20px] green-pink-gradient-border">
                    <div className="glassmorphism rounded-[20px] xs:p-8 py-8 px-6" style={{ boxShadow: 'none' }}>
                        <p className={`${styles.sectionSubText}`}>Get in touch</p>
                        <h3 className={`${styles.sectionHeadText}`}>Contact</h3>
                        <form ref={formRef} onSubmit={handleSubmit} className="mt-8 flex flex-col gap-8 items-center">
