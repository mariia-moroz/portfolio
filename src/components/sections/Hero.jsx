        ...
        <div className='flex gap-5'>
          ...
          >
            ...
            <p className={`${styles.heroSubText} mt-3 text-white-100`}>
              ...
              London, UK 🇬🇧 <br />I build scalable web applications and
              real-time data systems using JavaScript/TypeScript, Node.js, and
              React. My experience covers both backend and frontend development,
